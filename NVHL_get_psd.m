function out = NVHL_get_psd(cfg_in, data_in)
%NVHL_get_psd  simply computes the PSD using Welch's average for input data.
%
%Inputs:
...
% house keeping
out.cfg.history.mfun = mfun;
out.cfg.history.cfg = {cfg};

...
if isunix
    ...
    PARAMS.code_MS_dir = '/Users/jericcarmichael/Documents/GitHub/EC_NVHL'; % where the NVHL repo can be found
    ...
    PARAMS.code_MS_dir = 'D:\Users\mvdmlab\My_Documents\GitHub\EC_NVHL'; % where the NVHL repo can be found
end

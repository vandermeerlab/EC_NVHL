...
clear all
close all
cd('/Users/jericcarmichael/Documents/R111-2017-06-20-Rec_auto for Eroc')
...
%% Load everything
cfg         = [];
cfg.dataset = 'CSC24.Ncs';
data = ft_read_neuralynx_interp({'CSC24.ncs'});
